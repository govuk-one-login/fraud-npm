...
export function addStandardNotificationFields(event: EventStructure,
                                              ...
                                              initiatingEntity: string, reasonAdmin: string) {
...
async function generateNotificationDeviceSubjectEvents(eventType: NotificationEventTypes, deviceId: string,
                                                      timestampType: TimestampTypes, startTimeInMillis: number,
                                                      endTimeInMillis: number): Promise<SETEvents> {
...
export const notificationPopulatedEventsMapping: Record<string, (id: string,
